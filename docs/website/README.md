...
- linux kernel
  ...
  - [linux Driver API - Driver Basics](https://docs.kernel.org/driver-api/basics.html)
...
- qemu
  ...
  - [qemu monitor命令行](https://www.qemu.org/docs/master/system/monitor.html)
  - [qemu man page选项](https://www.qemu.org/docs/master/system/qemu-manpage.html)
  - [qemu选项](https://www.qemu.org/docs/master/system/invocation.html)
  - [qemu设备仿真](https://www.qemu.org/docs/master/system/device-emulation.html)
  - [qemu introduction](https://www.qemu.org/docs/master/system/introduction.html)
  - [qemu对象模型](https://www.qemu.org/docs/master/devel/qom.html)
  - [qemu clock](https://www.qemu.org/docs/master/devel/clocks.html)
  - [qemu reset](https://www.qemu.org/docs/master/devel/reset.html)
  - [qemu block chaining](https://www.qemu.org/docs/master/devel/tcg.html#direct-block-chaining)
  - [qemu self-modifying-code](https://www.qemu.org/docs/master/devel/tcg.html#self-modifying-code-and-translated-code-invalidation)
  - [qemu cpu指令描述文件-insn.decode](https://www.qemu.org/docs/master/devel/decodetree.html)
  - [qemu qom API](https://www.qemu.org/docs/master/devel/qom-api.html)
  - [qemu qdev API](https://www.qemu.org/docs/master/devel/qdev-api.html)
  - [qemu RCU](https://www.qemu.org/docs/master/devel/rcu.html)
  - [qemu memory API](https://www.qemu.org/docs/master/devel/memory.html)
  - [qemu build system](https://www.qemu.org/docs/master/devel/index-build.html)
  - [qemu test](https://www.qemu.org/docs/master/devel/testing/index.html)
  - [qemu TCG IR](https://www.qemu.org/docs/master/devel/tcg-ops.html)
  - [qemu项目开发流程](https://www.qemu.org/docs/master/devel/index-process.html)
- llvm
